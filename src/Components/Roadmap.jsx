        ...
        <div id='roadmap' className='pb-16 md:pb-32'>
            ...
            <div className='flex flex-col md:flex-row justify-center gap-5 mb-12 mx-6 md:mx-0'>   
                ...
                <div data-aos="fade-up" data-aos-duration="2000" className='text-white rounded-md shadow-xl p-5 border-l-4 border-white'>
                    ...
                    <ul>
                        <li className='font-Roboto'>7. Launch Discord and grow our community server to become a leading hub for the community and discussions.</li>
                        <li className='font-Roboto'>8. Launch our colletion Bored Ape Sui Club on Sui Mainnet.</li>
                        <li className='font-Roboto'>9. Holders Verification on Discord, NFT owners will be able to verify their NFTs to become voting members of the DAO.</li>
                        ...
                        <li className='font-Roboto'>12. Alpha calls, Whitelist contests for the top tier projects, NFT Giveaways, Airdrops News, Crypto and NFT Analysis.</li>
                    </ul>
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row justify-center gap-5 mb-12 mx-6 md:mx-0'>
                ...
                <div data-aos="fade-up" data-aos-duration="2500" className='text-white border-l-4 border-white rounded-md shadow-xl p-5'>
                    ...
                    <ul className='font-Roboto'>
                        ...
                        <li>15. The holders of Bored Ape Sui Club and Mutant Ape Sui Club are going to be automatically whitelisted for Kennel Ape Sui Club. You will need to hold a Bored Ape and a Mutant Ape to be in the Kennel Ape List.</li>
                        <li>16. Launch our colletion Kennel Ape Sui Club on Sui Mainnet.</li>
                        <li>17. Proceeds from Kennel Ape Sui Club NFT sales to fund DAO Development. All the funds and royalties are going to the DAO wallet.</li>
                    </ul>
                </div>
            </div>
            ...
            <div  className='flex flex-col md:flex-row justify-center mb-5 mx-6 md:mx-0'>
                <div data-aos="fade-up" data-aos-duration="3000" className='text-white border-l-4 border-white rounded-md shadow-xl p-5'>
                    ...
                    <ul className='font-Roboto'>
                        <li>19. The funds generated by this collections are going to aquire a BAYC and continue our future plans.</li>
                        <li>20. Those are going to be our first steps, after that our holders are going to decice the future of the projects by voting in our DAO.</li>
                    </ul>
                </div>
            </div>
